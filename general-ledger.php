...
<div class="toolbar">
	...
	<div class="toolbar-text" style="margin-top:34px;">
		...
		<div style="display: inline-block; float: left; margin-top: 6px; margin-right: 15px;">
			<span id="FLTR_DTE"  class="fa fa-calendar toolbar fa-lg" style="padding:3px;padding-left:0px;cursor:pointer" title="Filter by date">
		</div>
	</div>
</div>
...
<div id="mainResult" class="tabContaier" style="border-color:transparent;">
...
<script type="text/javascript">
	...
	var url = setDefaultQuery(new URI("general-ledger-ls.php"));
	...
	document.getElementById("FLTR_DTE").onclick = function() {
		var url = setDefaultQuery(new URI("general-ledger.php"));
