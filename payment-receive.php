...
if($_GET['DEL_A']!=""){
	$query="UPDATE RTL.PYMT_RCV SET DEL_NBR='".$_SESSION['personNBR']."' WHERE PYMT_RCV_NBR='".$_GET['DEL_A']."'";
...
<body>
	<div class="toolbar">
		<p class="toolbar-left"><a href="payment-receive-edit.php?RCV_NBR=-1"><span  class="fa fa-plus toolbar" style="cursor:pointer" ></span></a></p>
	...
	<script type="text/javascript">
		...
		$("#mainResult").load("payment-receive-ls.php", function () {
	...
	<script type="text/javascript">
		var url = new URI("payment-receive-ls.php");
