...
if ($_GET['DEL_L']!="") {
	$query = "UPDATE CMP.PRN_PPR_EQP SET DEL_NBR=" . $_SESSION['personNBR'] . " WHERE PRN_PPR_EQP='" . $_GET['DEL_L'] . "'";
...
<body>
<div class="toolbar">
	<p class="toolbar-left"><a href="print-paper-eqp-edit.php?PRN_PPR_EQP=-1"><span  class="fa fa-plus toolbar" style="cursor:pointer" ></span></a></p>
...
<script type="text/javascript">
	...
	$("#mainResult").load("print-paper-eqp-ls.php", function () {
...
<script type="text/javascript">
	var url = new URI("print-paper-eqp-ls.php");
