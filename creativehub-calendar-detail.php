        ...
        <?php
            ...
            if(isset($_GET['start'])) {
                ...
                $sql = "SELECT DET.ORD_DET_NBR,
                        ...
                        WHERE DET.ORD_NBR != 0 
                                AND DET.DEL_NBR= 0
                                AND DATE(DET.BEG_TS)= '$start_date' "; 
                            // echo "<pre>". $sql;
            ...
            <table style="width: 100%">
                <tbody style="line-height: 10px;">
                    ...
                    <div>
                        ...
                        <tr data-order="<?php echo $row['ORD_NBR']; ?>">
                            <td style="text-align:left;white-space:nowrap;float:left;">Mulai: <?php echo $row['BEG_TS']; ?></td>
                        </tr>
                        <tr data-order="<?php echo $row['ORD_NBR']; ?>">
                            <td style="text-align:left;white-space:nowrap;float:left;">Selesai: <?php echo $row['END_TS']; ?></td>
                        </tr>
                        <tr data-order="<?php echo $row['ORD_NBR']; ?>">
