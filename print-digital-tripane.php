...
<table class="pane-adjust" style='height:100%;padding:0px;'>
	<tr style='height:100%'>
		<td class="leftpane-adjust">
			...
			<iframe id="leftpane" borderframe=0 src="print-digital.php?STT=<?php echo $OrdSttId; ?>&TYP=<?php echo $type; ?>&GOTO=TOP" style="width:100%;overflow:hidden;height:calc(100% - 4px);" onmouseover="this.focus();"></iframe></div>
		</td>
