...
<script type="text/javascript">
	...
	function calcPay(){
		...
		document.getElementById("PRN_PPR_EQP_PRC_PCS").value=window.printEquipmentPrice/getInt('ORD_Q');
		...
		if(backtoback.checked === true){
			...
			document.getElementById('PRN_PRC').value=parseInt(((getInt('ORD_Q')/getInt('N_UP2')) * 2) * 1.1);
			/*
			if(getInt('QTY_PPR') > 1000){
				document.getElementById('TOT_PRN_PRC').value = minimunQty * 
			}
			*/
		}else{
			document.getElementById('QTY_PPR').value=roundTo(parseInt((getInt('ORD_Q')/getInt('N_UP1')) * 1),50);
			document.getElementById('PRN_PRC').value=parseInt(((getInt('ORD_Q')/getInt('N_UP2')) * 1) * 1.1);
		}
...
<form enctype="multipart/form-data" action="#" method="post" style="width:400px" onSubmit="return checkform();">
	<table>
		...
		<tr>
			<td>Jenis Mesin</td>
			<td>
				<select style="margin:0px;padding:0px;width:290px;" id="PRN_PPR_EQP_TYP" name="PRN_PPR_EQP_TYP" class="chosen-select">
				<?php
		...
		<tr>
			<td>Plat</td>
			<td>
				<select style="margin:0px;padding:0px;width:140px;" id="PRN_PPR_EQP_PRC_TYP" name="PRN_PPR_EQP_PRC_TYP" onchange="setPriceEqp(this.value);calcPay();"  class="chosen-select">
					<option value="">Pilih Plat</option>
				</select>
				
				Harga
				<input id="PRN_PPR_EQP_PRC" name="PRN_PPR_EQP_PRC" value="<?php echo $prnDigPrc; ?>" type="text" style="width:100px;" readonly />
			</td>
		</tr>
		...
		<tr style="<?php if($UpperSec > 7){echo 'display:none';}?>">
			...
			<td>
				<input id="PRN_PPR_EQP_PRC_PCS" name="PRN_PPR_EQP_PRC_PCS" value="" type="text" style="width:50px;" readonly />/Pcs&nbsp;&nbsp;
				<input id="PRN_PPR_EQP_OVER" name="PRN_PPR_EQP_OVER" value="" type="text" style="width:50px;" readonly />&nbsp;&nbsp;
				<input id="PRN_PPR_EQP_PRC_TTL" name="PRN_PPR_EQP_PRC_TTL" value="" type="text" style="width:50px;" readonly />
			</td>
		</tr>
		<tr>
			<td>Desain</td>
		...
		<tr>
			<td>Cetak</td>
			<td>
				<input id="PRN_PRC" name="PRN_PRC" value="<?php echo $row['PRN_PRC']; ?>" type="text" style="width:100px;" />
