...
<div class="toolbar">
	...
	<div class="toolbar-text">
		...
		<select class="chosen-select"  onchange="getContent('report','calendar-report-list-disp.php?CO_NBR='+this.value);">
			<?php	
			...
			$query="SELECT CO_NBR,NAME,CONCAT(NAME,' ',ADDRESS,' ',CITY_NM) AS CO_DESC
						...
						WHERE CO_NBR IN (1,2,3,4,5,6) ORDER BY 2";
				genCombo($query,"CO_NBR","NAME",1);
			?>
		</select>
...
<div id="report"></div>
<script>getContent('report','calendar-report-list-disp.php?CO_NBR=1');</script>
<br />	
</body>
</html>
