<?php
	...
	{	
		ob_start();
		include __DIR__ . DIRECTORY_SEPARATOR . "ajax/store-inventory-sub-cat.php";
...
<head>
	...
	<table class="std-row-alt table-freeze rowstyle-alt colstyle-alt no-arrow searchTable" >
        ...
        <tbody>
			...
			<tr>
				<td class="std" style="text-align:center;"><?php echo number_format($data->INV_NBR, 0, '.', ','); ?></td>
...
<?php
buildPagination($results->pagination, "store-inventory-matter-ls.php"); 
?>
