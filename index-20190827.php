        ...
        <td class="topmenu" colspan="2">
            <p class="top-left">
				...
				if ($locked==0) {
					...
					?>
					<span style="<?php echo $displaylock; ?>" class="fa-stack fa-1x topmenu" onclick="changeUrl('leftmenu','report-lm.php');changeUrl('content','bank-statement.php?ACTG=0');selTopMenu(this);">
						<span class="fa fa-archive fa-stack-2x topmenuicon"></span>
					</span>
					<?php	
					}
