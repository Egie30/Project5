                    ...
                    <div data-page="index" class="page">
                        ...
                        <div class="page-content">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="item-inner item-content">
                                                ...
                                                <div id="chart-rev" class="item-description" style="margin-bottom:3px;height:500px"></div>
                                                <?php
                                                //     $i = 0;
                                                //     foreach ($CoNbrs as $CoNbr) {
                                                ...
                                                // }
                                                echo "<div class='item-title-row'>";
                                                echo "<div class='item-description'>@Kopi Tugu</div>";
                            ...
                            <?php if ($upperSecurity < 4) { ?>
                                <div id="daily-revenue-retail" style="margin-bottom:3px;height:350px"></div>
                                <div class="list-block media-list contacts-block">
                                    <div class="item-inner item-content">
                                                <div class='item-title-row'>
                                                    <div class='item-title'>Total Revenue</div>
