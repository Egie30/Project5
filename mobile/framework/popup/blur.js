		...
		return this.each(function () {
			...
			tempImg.onload = function () {
				if(!isCached) {
					...
					// Begin Stan O's modification
					heightRatio=$(window).height()/tempImg.height;
					widthRatio=$(window).width()/tempImg.width;
					...
					ctx.drawImage(tempImg, 0, 0 ,tempImg.width*ratio,tempImg.height*ratio);
					// End
