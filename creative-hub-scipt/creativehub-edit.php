...
<head>
    ...
    <style type="text/css">
		...
		.right-col .info label[for=ORD_STT_ID] {
            grid-column: 1/2;
        }
        ...
        .right-col .info .chosen-container:nth-last-of-type(2) {
		 ...
		 .right-col .info label[for=SLS_PRSN_NBR] {
            text-align: center;
            grid-column: 4/5;
        }

        .right-col .info #SLS_PRSN_NBR,
        #SLS_PRSN_NBR_chosen,
        ...
        <div class="left-col">
            <div class="tanggal">
                ...
                <input type="text" name="ORD_BEG_DTE" id="ORD_BEG_DTE"
                       value="<?php echo ($row['ORD_BEG_TS'] == "") ? "" : parseDate($row['ORD_BEG_TS']) ?>" required/>

                <label for="ORD_END_DTE">Tanggal Selesai</label>
                <input type="text" name="ORD_END_DTE" id="ORD_END_DTE"
                       value="<?php echo ($row['ORD_END_TS'] == "") ? "" : parseDate($row['ORD_END_TS']) ?>" required/>
            ...
            <div class="waktu">
                ...
                <input name="ORD_BEG_TME" id="ORD_BEG_TME" type="text"
                       value="<?php echo ($row['ORD_BEG_TS'] == "") ? "" : parseTime($row['ORD_BEG_TS']) ?>" required/>
