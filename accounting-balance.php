...
if ($_GET['DEL_L']!="") {
	$query = "UPDATE RTL.ACCTG_TB SET DEL_NBR=" . $_SESSION['personNBR'] . " WHERE TB_NBR=" . $_GET['DEL_L'];
...
<table class="submenu">
	<tr>
		...
		<?php if ($Actg != 0) { ?>
			<p class="toolbar-left"><a href="accounting-balance-edit.php?BK_NBR=<?php echo $bookNumber; ?>&TB_NBR=-1&ACTG=<?php echo $Actg;?>"><span class="fa fa-plus toolbar" style="cursor:pointer"></span></a></p>
		<?php } ?>
...
<script type="text/javascript">
	...
	var url = new URI("accounting-balance-ls.php");
