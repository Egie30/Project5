...
if ($Type == 'ACTG') { 
	$file = "procurement-payment-report.php";
} else { 
	$file = "procurement-report.php";
}
...
<table class="table-accounting tablesorter">
	<thead>
		<tr style="text-align:center">
			...
			if($_GET['GROUP'] == "CAT_SUB_NBR") { 
				...
				echo "<th class='sortable'>Biaya Tambahan</th>";
	...
	<tbody>
		...
		foreach ($results->data as $data) {
			...
			<tr>
				...
				<td class="std" style="text-align:right"><?php echo number_format($data->TOTAL_SUB, 0, ',', '.');?></td>
				<td class="std" style="text-align:right"><?php echo number_format($data->HED_FEE_MISC, 0, ',', '.');?></td>
	...
	<tfoot>
		<tr style="border-top:1px solid grey">	
			...
			<td class="std" style="text-align:right;font-weight:bold;"><?php echo number_format($results->total->TOTAL_SUB, 0, ',', '.');?></td>
			<td class="std" style="text-align:right;font-weight:bold;"><?php echo number_format($results->total->HED_FEE_MISC, 0, ',', '.');?></td>
...
<?php buildPagination($results->pagination, "procurement-report-ls.php"); ?>
