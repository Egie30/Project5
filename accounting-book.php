...
if ($_GET['DEL_L']!="") {
	$query = "UPDATE RTL.ACCTG_BK SET DEL_NBR=" . $_SESSION['personNBR'] . " WHERE BK_NBR=" . $_GET['DEL_L'];
...
<body>
<div class="toolbar">
	<p class="toolbar-left"><a href="accounting-book-edit.php?BK_NBR=-1"><span class="fa fa-plus toolbar" style="cursor:pointer"></span></a></p>
...
<script type="text/javascript">
	...
	$("#mainResult").load("accounting-book-ls.php", function () {
...
<script type="text/javascript">
	var url = new URI("accounting-book-ls.php");
