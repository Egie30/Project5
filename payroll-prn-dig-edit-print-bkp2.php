<?php
	...
	$string .= followspace("         Transportasi           : Rp. " . leadSpace($Transport, 9) . " x " . leadspace($totDist, 3) . " km  =   Rp. " . leadspace($row['AUTH_TRVL_AMT'], 10), 76) . leadspace("", 10) . followspace("Potongan Bon/Bulan", 21) . ":" . " Rp. " . leadspace($row['DED_DEF_PRSN'], 11) . "            " .  chr(13) . chr(10);
