<?php
	...
	while($row=mysql_fetch_array($result)){
		...
		echo "<div class='listable-btn' style='margin-left:5px'><span class='fa fa-trash listable-btn' onclick=".chr(34)."syncGetContent('pay','print-digital-payment-list.php?ORD_NBR=".$OrdNbr."&PYMT_NBR=".$row['PYMT_NBR']."&TYP=".$type."&PYMT_TYP=DEL');calcAmt();".chr(34)."></span></div>";
		}
		$TotNet+=$rowa['TOT_SUB'];
