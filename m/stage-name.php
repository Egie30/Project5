<?php
	...
	if(LuhnVal($PrsnNbr)){
		...
		echo "<script id='runScriptName' type='text/javascript'>scanType='O';</script>";
		...
		echo "<div class='scan-fail'><img src='img/generic.jpg' style='border-radius:50% 50% 50% 50%;width:50px;height:50px;vertical-align:-120%'>&nbsp;&nbsp;Employee ID tidak dikenal</div>";
	}
?>