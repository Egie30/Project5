	...
	function KeyCheck(e)
	{
  		...
  		if(KeyID==13){
  			...
  			if(scanType=='E'){
				...
				syncGetContent('data','audit-name.php?PRSN_NBR='+document.getElementById('scan').value);
				...
				syncGetContent('header','audit-item.php?INV_BCD='+document.getElementById('scan').value);
				//alert(document.getElementById('scan').value);
				eval(document.getElementById("runScriptOrder").innerHTML);
				document.getElementById('detail').style.display='';
				syncGetContent('detail','audit-list.php?INV_BCD='+document.getElementById('scan').value+'&PRSN_NBR='+prsnNbr);
				document.getElementById('scan').value='';
				scanType=='I';
			}
	  	}else{
...
<div class='title'>
	Stock Opname<input name="scan"id="scan" style='width:0px;height:0px;padding:0px;border-color:#474747' readonly>
</div>
