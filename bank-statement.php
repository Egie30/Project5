...
if ($_GET['DEL']!="") {
	$query = "UPDATE RTL.BNK_STMT SET DEL_NBR=" . $_SESSION['personNBR'] . " WHERE BNK_STMT_NBR=" . $_GET['DEL'];
...
<body>
<div class="toolbar">
	<p class="toolbar-left"><a href="bank-statement-edit.php?BNK_STMT_NBR=-1"><span  class="fa fa-plus toolbar" style="cursor:pointer" ></span></a></p>
...
<script type="text/javascript">
	...
	$("#mainResult").load("bank-statement-ls.php", function () {
...
<script type="text/javascript">
	var url = new URI("bank-statement-ls.php");
