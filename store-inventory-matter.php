	...
	<body>
		...
		<script type="text/javascript">
				function setDefaultQuery(url) 
					...
					var url = setDefaultQuery(URI("store-inventory-matter-ls.php"));
					...
					document.getElementById("FLTR_DTE").onclick = function () {
						var url = setDefaultQuery(URI("store-inventory-matter.php"));
		...
		<script type="text/javascript">
				var url = setDefaultQuery(new URI("store-inventory-matter-ls.php"));
