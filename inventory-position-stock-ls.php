...
<table id="mainTable" class="table-accounting tablesorter">
	<thead>
		<tr>
			...
			<th class="sortable" style="white-space:nowrap;">Sub Departemen</th>
	...
	<tbody>
		...
		foreach ($results->data as $data) {
			...
			<td class="std" style="text-align:left"><?php echo $data->INV_BCD ;?></td>
...
<?php buildPagination($results->pagination, "inventory-position-stock-ls.php");?>