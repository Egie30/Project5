<?php
	...
	if ($row['BON_ERNG']>0){
		$string .= followspace("                                    Earning Bonus  =   Rp. " . leadSpace($row['ERNG_BNS_AMT'], 10), 76) . leadspace("", 10) . chr(13) . chr(10);
	}
	
	if ($row['PAY_OUT_CMSN']>0){
		$string .= followspace("                               Outsource Commission    =   Rp. " . leadSpace($row['PAY_OUT_CMSN'], 10), 76) . leadspace("", 10) . chr(13) . chr(10);
	}
