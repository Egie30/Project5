...
<div class="toolbar">
	...
	<div class="toolbar-text">
		...
		if($locked == 0) { 
			$style0 = 'margin-top: 45px; margin-right: 10px;';
		...
		<div style="display: inline-block; float: left; <?php echo $style1; ?>">
...
<script type="text/javascript">
	...
	var url = setDefaultQuery(new URI("profit-lost-statement-ls.php"));
	...
	document.getElementById("FLTR_DTE").onclick = function() {
		var url = setDefaultQuery(new URI("profit-lost-statement.php"));
