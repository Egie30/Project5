...
//	}
    ...
    foreach($CoNbrs as $CoNbr){
        ...
        $KMC6501[]=explode(',',$DashboardProdStat[5]);
        $Rev[]=$DashboardProdStat[6];
        $Flex[]=explode(',',$DashboardProdStat[7]);
        $Doc[]=explode(',',$DashboardProdStat[8]);
        $Dte[]=$DashboardProdStat[9];
        $DRev[]=$DashboardProdStat[10];
        $volFLJ320P[]=$DashboardProdStat[11];
        $volKMC6501[]=$DashboardProdStat[12];
        $volRVS640[] =$DashboardProdStat[13];
        $volAJ1800F[]=$DashboardProdStat[14];
        $volMVJ1624[]=$DashboardProdStat[15];
        $volHPL375[] =$DashboardProdStat[16];
        $i++;
    }
?>
...
<div class="views">
    <div class="view view-main">
        ...
        <div class="pages navbar-through toolbar-through layout-dark">
                                    ...
                                    <div class="row" style="margin-top:20px">
                                        <div class="col-50 item-description">
                                            <div class='item-title-row'>
                                                <div class='item-title' style="color:#ffffff;margin-bottom:15px">Today's Revenue</div>
                                            </div>
                                            <?php
                                                $i=0;
                                                foreach($CoNbrs as $CoNbr){
                                                    echo "<div class='item-title-row' style='line-height:normal'>";
                                                    echo "<div class='item-description' style='font-size:9pt;line-height:normal'>".str_replace("Champion ","",$CoName[$i])."</div>";
                                                    echo "<div class='item-description color-nestor' style='font-size:9pt;line-height:normal'>Rp. ".number_format($Rev[$i],0,'.',',')."</div>";
                                                    echo "</div>";
                                                    $TotRev+=$Rev[$i];
                                                    $i++;
                                                }
                                            ...
                                            <div class='item-title-row'>
                                                ...
                                                <div class='item-description' style="font-size:9pt;color:#ffffff">Rp. <?php echo number_format($TotRev,0,'.',','); ?></div>
                                            </div>
                                            <div class='item-title-row' style="margin-top:10px">
                                                <div class="item-description" style="font-size:7pt;line-height:normal">Last update:<br><?php echo date("Y-m-d H:i:s"); ?></div>
                                            </div>
                                        </div>
                        ...
                        <ul>
                            <li>
                                ...
                                <div class="item-title col-100" style="margin-bottom:10px">Production @<?php echo $CoName[$i]; ?></div>
                                    <div id="chart-vol<?php echo $i; ?>" class="item-description" style="margin-bottom:3px;height:120px"></div>
                                </div></li></ul></div>
                    <div class="list-block media-list contacts-block">
                    <div class="item-inner item-content">
                        <div class="row">
...
<script>
    function displayChart(){
        Highcharts.setOptions({
            colors: [{linearGradient: {x1: 0, y1: 0, x2: 0, y2: 1}, stops: [[0, '#429cfa'],[1, '#1084f9']]},
