<?php
	...
	{
		$query="DELETE FROM CMP.PAYROLL_LOC WHERE PRSN_NBR=".$_GET['DEL']." AND PYMT_DTE='".$_GET['DATE']."'";
...
<div id="mainResult">
	<table id="mainTable" class="tablesorter searchTable">
		...
		<?php
			...
			{
				echo "<tr $alt style='cursor:pointer;' onclick=".chr(34)."location.href='payroll-salary-edit.php?PRSN_NBR=".$row['PRSN_NBR']."';".chr(34).">";
...
<script>liveReqInit('livesearch','liveRequestResults','payroll-salary-ls.php','','mainResult');</script>
