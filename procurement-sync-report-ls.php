...
if ($Type == 'ACTG') { $file = "procurement-payment-report.php"; }
	else { $file = "procurement-report.php"; }
...
<table class="table-accounting tablesorter">
	<thead>
		<tr style="text-align:center">
			...
			<th class="nosort" style="padding:2px">
		...
		foreach ($results->data as $data) {
			...
			<tr>
				...
				<td style='padding:2px;text-align:center'>
					<input name='SEL_IMG_<?php echo $data->ORD_NBR;?>' id='SEL_IMG_<?php echo $data->ORD_NBR;?>' type='checkbox' class='regular-checkbox' onclick="event.cancelBubble=true;"/>
					<label for='SEL_IMG_<?php echo $data->ORD_NBR;?>' style='margin-right:0px;margin-top:5px' onclick="event.cancelBubble=true;"></label>
				</td>
				<?php } ?>
				<?php 
				if($_GET['GROUP'] == "CAT_SUB_NBR") {	
