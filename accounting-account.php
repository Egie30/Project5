...
if ($_GET['DEL_L']!="") {
	$query = "UPDATE RTL.ACCTG_CD_SUB SET DEL_NBR=" . $_SESSION['personNBR'] . " WHERE CD_SUB_NBR=" . $_GET['DEL_L'];
...
<body>
<div class="toolbar">
	<p class="toolbar-left"><a href="accounting-account-edit.php?CD_SUB_NBR=-1"><span  class="fa fa-plus toolbar" style="cursor:pointer" ></span></a></p>
...
<script type="text/javascript">
	...
	$("#mainResult").load("accounting-account-ls.php", function () {
...
<script type="text/javascript">
	var url = new URI("accounting-account-ls.php");
