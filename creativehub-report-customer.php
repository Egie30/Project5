...
<div class="toolbar">
	<p class="toolbar-left">
		...
		<span class="fa fa-calendar toolbar fa-lg" style="padding-left:0px;cursor:pointer" onclick="location.href='creativehub-report-customer.php?ORD_TS='+document.getElementById('ORD_TS').value+'&ORD_END_TS='+document.getElementById('ORD_END_TS').value"></span>
	</p>
