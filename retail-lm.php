...
<?php } ?>
<?php if ($SecurityFin<2) { ?>
<div class="leftmenu" id="retail-as" onclick="changeSiblingUrl('content','retail-stock.php?IVC_TYP=AS');selLeftMenu(this);">Assembly</div>
<div class="leftmenu" id="retail-ds" onclick="changeSiblingUrl('content','retail-stock.php?IVC_TYP=DS');selLeftMenu(this);">Disassembly</div>
...
<div style="<?php echo $displaylock; ?>" class="leftmenu" onclick="changeSiblingUrl('content','inventory-audit.php');selLeftMenu(this);">Stock Opname</div>
