...
<div class="toolbar-only">
	...
	<p class="toolbar-right">
		...
		<a href="print-digital-edit-print.php?ORD_NBR=<?php echo $OrdNbr; ?>&PRN_TYP=Invoice&TYP=<?php echo $type; ?>"><span class='fa fa-print toolbar'></span></a>
		<?php } ?>
		<a href="tes2.php?ORD_NBR=<?php echo $OrdNbr; ?>&PRN_TYP=Invoice&TYP=<?php echo $type; ?>"><span class='fa fa-print toolbar'></span></a>
			<!-- <img style="cursor:pointer" class="toolbar-right" src="img/excelicon16.png"> -->
		</a>
	</p>
</div>
