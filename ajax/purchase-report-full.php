...
SELECT
			...
			HED.SPL_NAME,
			HED.RCV_NAME,
			COALESCE(DATE(CSH_R.CRT_TS), DATE(CSH_D.CRT_TS)) AS ORD_DTE,
			COALESCE(YEAR(CSH_R.CRT_TS), YEAR(CSH_D.CRT_TS)) AS ORD_YEAR,
			COALESCE(MONTH(CSH_R.CRT_TS), MONTH(CSH_D.CRT_TS)) AS ORD_MONTH,
			COALESCE(DAY(CSH_R.CRT_TS), DAY(CSH_D.CRT_TS)) AS ORD_DAY,
			COALESCE(MONTHNAME(CSH_R.CRT_TS), MONTHNAME(CSH_D.CRT_TS)) AS ORD_MONTHNAME,
			HED.CAT_SUB_NBR,
			HED.CAT_SUB_DESC,
