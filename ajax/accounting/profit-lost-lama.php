...
$_GET['GROUP'] 		= array("MONTH", "CAT_SUB_NBR");
...
$results['data']['TOTAL_COST'] 			= (0.1 * ($resultsPayroll->total->PAY_AMT + $resultsRoutine->total->TOT_SUB )) + $resultsCash->total->TOT_SUB + $resultsCost->total->RCV_TOT_SUB;
