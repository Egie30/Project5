...
if($locked==1){ $displaylock = "display:none;"; }
...
<table class="main" >
		...
		<td class="topmenu" colspan="2">
			...
			<?php } else { ?>
				...
				<p id='top-left' class="top-left">	
					...
					<span style="<?php echo $displaylock; ?>" class="fa-stack fa-1x topmenu" onclick="changeUrl('search','address-person.php');selTopMenu(this);">
						<span class="fa fa-building fa-stack-1x topmenuicon"></span>
					</span>
				
					<span style="<?php echo $displaylock; ?>" class="fa-stack fa-1x topmenu" onclick="changeUrl('search','cash-day-report-edit.php?CSH_DAY_NBR=0&POS_ID=<?php echo $POSID; ?>&POSIP=<?php echo $POSIP; ?>&CSH=<?php echo $userID; ?>');selTopMenu(this);">
						<span class="fa fa-bank fa-stack-1x topmenuicon"></span>
					</span>
					
					<span class="fa-stack fa-1x topmenu" onclick="changeUrl('search','forms-sale-day-cashier.php?DAYS=0');selTopMenu(this);">
	...
	<tr>
		<td class="bottom" colspan="3">
			<iframe id="bottom" borderframe=0 src="cashier-bottom.php?CSH=<?php echo $_SESSION['userID'];?>" style='height:113px'></iframe>
		</td>
	</tr>
	<tr class="footer">
